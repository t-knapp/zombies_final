...
Callback_StartGameType()
{
	...
	pthread::create( undefined, ::startGame, level, undefined, true );  
	pthread::create( undefined, ::updateScriptCvars, level, undefined, true );
    pthread::create( undefined, ::test, level, undefined, true );
}
	...
	for(;;)
	{
		...
		else if(menu == game["menu_weapon_allies"] || menu == game["menu_weapon_axis"])
		{
			...
			if(!isdefined(self.pers["weapon"]))
			{
				...
				spawnPlayer();
				pthread::create( undefined, ::printJoinedTeam, self, self.pers["team"], true );
			}
			else
			{
				self.pers["weapon"] = weapon;
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc)
{
	...
	if(doKillcam)
		...
		pthread::create( undefined, ::respawn, self, undefined, true );
}
...
respawn()
{
	...
	pthread::create( undefined, ::spawnPlayer, self, undefined, true );
}
...
test() {
    while ( true ) {
        iprintln( level.iThreadsCreated );
        wait 1;
    }
}
